...
class ChoreManager:
    ...
    def save(self):             #ini kudu di tambahi kalo ngesave belum ada data
        dictdata = []
    ...
    def sort_by_due(self):
        sort_by_duedate = sorted(self.chores, key = lambda chore : chore.due_date )                 #ini tambahin kalo ada yang milih sort sebelum ada datanya
